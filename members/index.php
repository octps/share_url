...
<meta itemprop="name" content="puprl（パップル） <?= h($screen_name) ?>のページ | webでブックマークするサービス">
...
<meta property="og:title" content="puprl（パップル） <?= h($screen_name) ?>のページ | webでブックマークするサービス">
...
<meta name="twitter:title" content="puprl（パップル） <?= h($screen_name) ?>のページ | webでブックマークするサービス">
