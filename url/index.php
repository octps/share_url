...
<meta itemprop="name" content="puprl（パップル） <?= h($content[0]['title']) ?>へのコメント | webでブックマークするサービス">
...
<meta property="og:title" content="puprl（パップル） <?= h($content[0]['title']) ?>へのコメント | webでブックマークするサービス">
...
<meta name="twitter:title" content="puprl（パップル） <?= h($content[0]['title']) ?>へのコメント | webでブックマークするサービス">
